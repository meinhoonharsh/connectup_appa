...
class ExploreConnectUpScreen extends StatefulWidget {
  const ExploreConnectUpScreen({Key? key}) : super(key: key);

  @override
  State<ExploreConnectUpScreen> createState() => _ExploreConnectUpScreenState();
}

class _ExploreConnectUpScreenState extends State<ExploreConnectUpScreen> {
